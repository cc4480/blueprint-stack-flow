      ...
      <div className="container mx-auto px-6">
        ...
        <div className="space-y-8 mb-16">
          {stackLayers.map((layer, index) => (
            <Card 
              key={index} 
              className="bg-white/5 backdrop-blur-lg border-purple-400/20 p-8 hover:bg-white/10 transition-all duration-300 hover:border-purple-400/40 hover:scale-105"
            >
          ...
          <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 backdrop-blur-lg rounded-2xl p-8 border border-purple-400/20">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                ...
                size="lg"
                className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-8 py-4 text-lg font-semibold rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
              >
                Try the Stack Now
              ...
              <Button 
                ...
                variant="outline"
                size="lg"
                className="border-2 border-purple-400 text-purple-400 hover:bg-purple-400 hover:text-white px-8 py-4 text-lg font-semibold rounded-full transition-all duration-300"
              >
                Learn More
              </Button>
            </div>
