              ...
              {currentStep === 2 && <div className="space-y-6">
                  <div className="text-center mb-6">
                    <p className="text-lg text-gray-300">
                      ...
                      <span className="font-semibold text-purple-400">{formData.dataSource}</span>
                    </p>
                  </div>
              ...
              {currentStep === 4 && generatedResult && <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    <div className="bg-gradient-to-r from-blue-900 to-blue-800 p-4 rounded-lg text-center">
                      ...
                      <div className="font-semibold text-blue-100">{generatedResult.estimatedBuildTime}</div>
                    ...
                    <div className="bg-gradient-to-r from-purple-900 to-purple-800 p-4 rounded-lg text-center">
                      ...
                      <div className="font-semibold text-purple-100">{generatedResult.complexity}</div>
                    ...
                    <div className="bg-gradient-to-r from-green-900 to-green-800 p-4 rounded-lg text-center">
                      ...
                      <div className="font-semibold text-green-100">{generatedResult.mcpEndpoints?.length || 0}</div>
                    ...
                    <div className="bg-gradient-to-r from-orange-900 to-orange-800 p-4 rounded-lg text-center">
                      ...
                      <div className="font-semibold text-orange-100">{generatedResult.a2aProtocols?.length || 0}</div>
