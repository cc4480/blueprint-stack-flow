    ...
    <section className="relative min-h-screen flex items-center justify-center bg-black text-white overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-6xl mx-auto">
          {/* Cleaner logo showcase - reduced size and better spacing */}
          <div className="mb-12 flex justify-center">
            <div className="h-32 md:h-40 lg:h-48 w-auto">
              <img 
          ...
          {/* Main Headline - improved spacing */}
          ...
          {/* Enhanced Subheadline - better hierarchy */}
          <div className="text-lg md:text-xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed space-y-4">
          ...
          {/* Primary CTA Buttons - cleaner layout */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <Button 
              onClick={handlePromptGenerator}
              size="lg" 
              className="relative bg-gradient-to-r from-blue-500 via-purple-500 to-red-500 hover:from-blue-600 hover:via-purple-600 hover:to-red-600 text-white px-8 py-4 text-lg font-bold rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 border border-blue-300/30"
              style={{
            ...
            <Button 
              ...
              variant="outline" 
              size="lg"
              className="relative border-2 border-blue-400 text-blue-400 hover:bg-gradient-to-r hover:from-blue-400/10 hover:to-purple-400/10 hover:text-white px-8 py-4 text-lg font-bold rounded-full transition-all duration-300 transform hover:scale-105 backdrop-blur-sm bg-black/50"
              style={{
          ...
          {/* Secondary Action - cleaner spacing */}
          <div className="mb-16">
            <Button 
              onClick={handleWatchSeries}
              variant="ghost" 
              size="lg"
              className="relative text-gray-300 hover:text-white px-6 py-3 text-base font-semibold rounded-full border border-blue-400/30 hover:border-blue-400/60 transition-all duration-300 backdrop-blur-sm bg-black/30 hover:bg-black/50"
              style={{
