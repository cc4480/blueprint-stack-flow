        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
            ...
            <Button 
              ...
              variant="outline" 
              size="lg"
              className="relative border-2 border-blue-400 text-blue-400 hover:bg-gradient-to-r hover:from-blue-400/10 hover:to-purple-400/10 hover:text-white px-10 py-5 text-xl font-bold rounded-full transition-all duration-300 transform hover:scale-105 backdrop-blur-sm"
              style={{
          ...
          <div className="mb-16">
            <Button 
              ...
              variant="ghost" 
              size="lg"
              className="relative text-gray-300 hover:text-white px-8 py-4 text-lg font-semibold rounded-full border border-blue-400/30 hover:border-blue-400/60 transition-all duration-300 backdrop-blur-sm"
              style={{
