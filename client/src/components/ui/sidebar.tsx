      ...
      >
        ...
        <div
          className={cn(
            ...
            variant === "floating"
              ? "left-4 top-4 h-[calc(100svh-theme(spacing.8))] rounded-lg border bg-sidebar shadow-lg"
              : "left-0 top-0 bg-sidebar",
            variant === "inset"
              ? "left-4 top-4 h-[calc(100svh-theme(spacing.8))] rounded-lg"
              : "",
            "group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)]",
            "group-data-[collapsible=icon]:w-[--sidebar-width-icon]",
            "group-data-[side=right]:right-0 group-data-[side=right]:left-auto",
            "group-data-[side=right]:group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)] group-data-[side=right]:group-data-[collapsible=offcanvas]:left-auto",
            className
          )}
          {...props}
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col group-data-[variant=floating]:border-sidebar-border"
          >
            {children}
          </div>
        </div>
